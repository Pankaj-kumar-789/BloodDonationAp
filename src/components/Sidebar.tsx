  ...
  if (session) {
    ...
    if (session.user.role === "BLOOD_BANK") {
      menuItems.push(
        ...
        { name: "Notifications", icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>, path: "/dashboard/notifications", badge: 4 }
      );
      ...
      <div className="p-4 mt-auto">
        {session ? (
          <button 
            ...
            className={`w-full flex items-center py-3.5 px-4 rounded-xl cursor-pointer text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-semibold transition-all`}
