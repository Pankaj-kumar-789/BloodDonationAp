    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gray-50 border-r border-gray-100 dark:border-gray-800">
        ...
        <div className="absolute inset-0 p-12 flex flex-col justify-between">
          ...
          <div>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 drop-shadow-md">Be a Hero.</h2>
            <p className="text-lg text-gray-800 dark:text-gray-200 max-w-md font-medium drop-shadow-md">Join our growing community and help bridge the gap in medical emergencies.</p>
          </div>
        </div>
        <img 
          src={banner.src} 
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-gray-900 p-8 sm:p-10 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none border border-gray-100 dark:border-gray-800">
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Join RaktaSetu</h1>
              <p className="text-gray-500 dark:text-gray-400 text-base mt-2">Create an account to continue</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary-red hover:bg-red-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-md shadow-red-200 dark:shadow-none mt-6 disabled:opacity-70"
              >
            ...
            <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400 font-medium">
              ...
              <Link href="/login" className="text-primary-red font-bold hover:text-red-700 dark:hover:text-red-400 ml-1">
                Log in
              </Link>
            </div>
          </div>
