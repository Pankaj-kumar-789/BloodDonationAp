                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-6">
                  <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-3 flex items-center gap-3 transition-colors min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[13px] font-bold text-gray-900 dark:text-white transition-colors truncate">{hospital.city}, {hospital.state}</p>
                    </div>
                  </div>
                  <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-3 flex items-center gap-3 transition-colors min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[13px] font-bold text-gray-900 dark:text-white transition-colors truncate">{hospital.user.phone || "Not provided"}</p>
                    </div>
                  </div>
                </div>
