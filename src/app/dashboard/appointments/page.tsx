  ...
  return (
    <PageTransition className="max-w-5xl mx-auto space-y-6 mt-4 pb-10">
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition-colors">
        <div className="mb-8">
          <h1 className="text-3xl md:text-[2rem] font-black text-gray-900 dark:text-white mb-2 transition-colors">My Appointments</h1>
          <p className="text-gray-500 dark:text-gray-400 max-w-lg font-medium text-[15px] transition-colors">Manage your upcoming blood donation appointments.</p>
        </div>
        ...
        <div className="text-center py-20 bg-gray-50 dark:bg-slate-800/50 rounded-3xl border border-dashed border-gray-200 dark:border-slate-700 transition-colors">
          <div className="w-20 h-20 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm border border-gray-100 dark:border-slate-700 transition-colors">
            <Calendar className="w-10 h-10 text-gray-300 dark:text-gray-600 transition-colors" />
          </div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 transition-colors">No Appointments Scheduled</h3>
          ...
          <div className="mt-8 flex gap-4 justify-center">
            <Link href="/dashboard" className="inline-block bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 hover:border-gray-300 dark:hover:border-slate-600 text-gray-700 dark:text-gray-300 font-bold py-3 px-8 rounded-xl text-[14px] transition-colors shadow-sm">
               Go Back
            </Link>
