      ...
      <div className="flex h-48 lg:h-auto lg:w-1/2 relative bg-gray-50 dark:bg-slate-900 border-b lg:border-b-0 lg:border-r border-gray-100 dark:border-slate-800 shrink-0 transition-colors">
        ...
        <div className="absolute inset-0 p-6 lg:p-12 flex flex-col justify-between z-20">
          ...
          <div className="mt-auto lg:mt-0">
            <h2 className="text-2xl lg:text-5xl font-extrabold text-white lg:text-gray-900 dark:lg:text-white mb-2 lg:mb-4 drop-shadow-lg tracking-tight transition-colors">Save Lives Today.</h2>
            <p className="text-sm lg:text-xl text-white lg:text-gray-600 dark:lg:text-gray-400 max-w-md font-medium drop-shadow-lg hidden sm:block leading-relaxed transition-colors">Join thousands of donors and hospitals connecting instantly to save lives in critical moments.</p>
          </div>
        </div>
        <img 
          src={banner.src} 
        ...
        <div className="w-full max-w-md relative z-10 flex flex-col">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100 dark:border-slate-800 transition-colors">
            <div className="flex flex-col items-center mb-10">
              ...
              <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight transition-colors">Welcome Back</h1>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mt-2 transition-colors">Log in to RaktaSetu</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-bold text-gray-900 dark:text-white transition-colors">Password</label>
